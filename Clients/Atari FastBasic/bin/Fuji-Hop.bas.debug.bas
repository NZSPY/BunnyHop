...
' @version June 2026
' This is a client for the Fuji-Hop game server
...
AK_LOBBY_KEY_SERVER = 4     ' Fuji-Hop Client registered as Lobby appkey 4

' Fuji-Hop client
AK_CREATOR_ID = $B00B       ' Simon Young's creator id
AK_APP_ID = 1               ' Fuji-Hop app id
...
' Custom character set for FujiHop - 128 characters, 8 bytes each
' Size: 1024 bytes
...
data byte = 123,123,127,127,117,119,119,117,
data byte = 239,239,255,255,119,247,247,245,
data byte = 180,180,244,244,116,116,116,116,
data byte = 119,119,119,119,31,31,21,5,
data byte = 245,247,247,247,255,255,85,85,
data byte = 116,116,116,116,212,208,80,64,
data byte = 165,149,154,154,106,106,106,106,
data byte = 170,170,170,170,170,170,170,170,
data byte = 0,8,8,32,32,128,128,0,
...
data byte = 170,255,255,234,234,234,234,255,
data byte = 170,255,255,235,235,234,234,234,
data byte = 255,235,235,235,235,235,235,255,
data byte = 255,255,235,235,171,171,175,174,
data byte = 186,186,186,186,186,186,186,170,
data byte = 5,21,26,26,106,107,107,107,
data byte = 85,85,170,170,170,255,255,170,
data byte = 64,80,144,148,164,164,164,228,
data byte = 107,107,107,107,107,107,107,107,
data byte = 170,170,170,170,170,170,170,255,
data byte = 228,228,228,228,228,228,228,228,
data byte = 107,107,107,107,107,107,107,107,
data byte = 255,170,170,170,170,170,170,170,
data byte = 228,228,228,228,228,228,228,228,
data byte = 107,107,107,106,26,26,22,5,
data byte = 170,255,255,170,170,170,170,85,
data byte = 228,164,164,164,148,144,80,64,
data byte = 5,21,26,26,106,107,107,107,
data byte = 85,85,170,170,170,255,255,170,
data byte = 64,80,144,148,164,164,164,228,
data byte = 107,107,107,107,107,107,107,107,
...
data byte = 170,255,255,170,170,170,170,85,
data byte = 228,164,164,164,148,144,80,64,
data byte = 0,10,47,191,181,183,183,183,
data byte = 0,128,224,248,120,248,248,248,
data byte = 183,183,183,181,191,47,10,0,
data byte = 248,248,248,120,248,224,128,0,
...
if serverEndpoint$<>""
  ...
  serverEndpoint$="N:https://bunnyhop.spysoft.nz"
  QUERY$=""$9B 
...
PROC ResetScreen
  ...
  poke screen, 59:poke screen+39,60
  poke screen+40*24, 61:poke screen+40*25-1,62
ENDPROC
